...
function App() {
  ...
  return (
    <div className="p-2 flex flex-col items-center  min-h-screen w-full sm:w-[90%] md:w-[80%] lg:w-[60%] xl:w-[50%] 2xl:w-[40%] mx-auto">
      ...
      {/* Botões de seleção */}
      <div className="mt-8 grid grid-cols-5 gap-x-2 h-40 md:h-48 lg:h-56 w-full">
        ...
        <button className='pt-8 shadow-md shadow-emerald-200 rounded-md bg-linear-to-t from-green-400 to-emerald-600' onClick={() => setModalidade("Mega-Sena")}><h5 className='text-white text-2xl font-[Shadows_Into_Light] rotate-270 whitespace-nowrap'>Mega Sena</h5></button>
        ...
        <button className='pt-8  shadow-md shadow-amber-200 rounded-md bg-linear-to-t from-yellow-400 to-amber-700' onClick={() => setModalidade("Dia de Sorte")}><p className='text-white text-2xl font-[Shadows_Into_Light] rotate-270 whitespace-nowrap'>Dia de Sorte</p></button>
      </div>
