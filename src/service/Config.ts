...
export const configs: Record<Modalidade, { api: string; gradient: string ,background:string,color:string,borda:string,fundo:string}> = {
  "Quina": {
  ...
  "Lotofácil": {
    ...
    gradient: "from-purple-700 to-indigo-300 ",
